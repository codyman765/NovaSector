...
/mob/living/proc/adjust_pain(change_amount = 0, mob/living/partner, datum/interaction/interaction, position)
	if((stat >= DEAD || !client?.prefs?.read_preference(/datum/preference/toggle/erp)) && !(!ishuman(src) && !src.client))
		return
